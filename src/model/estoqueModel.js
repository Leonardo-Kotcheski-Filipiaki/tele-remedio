 ...
 */
export async function registrarItem(item){
    return new Promise(async (resolve, reject) => {
        try {
            await validaInfos(item).then(res => {
                if(res){
 ...
 */
export async function listarItem(listaveis){
    return new Promise(async (resolve, reject) => {
        try {
 ...
 * @returns Objeto
 */
export async function listagem(data){
...
/**
 * Função para alterar a quantidade do item (A FAZER!!)
 * @author Leonardo Kotches Filipiaki devleonardokofi
 * @param {Object} data É esperado o id do item a ser alterado 
 * @returns Objeto
 */
// export async function quantidade(data){
//     return await new Promise(async (resolve, reject) => {
//         try {
//             let query = "UPDATE estoque SET listar = ? WHERE item_id = ?";
//             conn.connect();
 ...
 */
async function validaInfos(item){
    return new Promise(async (resolve, reject) => {
        try{
            let result = Item.parse(item);
            if(result){
                conn.connect();
