...
CREATE TABLE IF NOT EXISTS `teleremedio`.`usuarios` (
  ...
  `estado` TINYINT NOT NULL DEFAULT 1 COMMENT 'Se usuario está ativo = 1 ou inativo = 2',
  `tipo` INT NOT NULL COMMENT '/*Códigos de tipos de usuario, Usuario padrão: 0303 | Usuario Administrador: 0001*/',
  PRIMARY KEY (`user_id`),
